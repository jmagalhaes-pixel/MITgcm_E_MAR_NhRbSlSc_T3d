function [ Pxx, Pyy, Pxy, coh, pha, freq ] = func_coherence2( f1, f2, Fs )

% Modified by MCB, 2009-07-30
...
% default
[Pxx,freq] = cpsd( f1, f1, [], [], [], Fs);
[Pyy,freq] = cpsd( f2, f2, [], [], [], Fs);
[Pxy,freq] = cpsd( f1, f2, [], [], [], Fs);
