%% function [power,sdens,period,freq] = fft_win_win(t,y,win,numwin,rmfit)
...
function [power,sdens,period,freq] = fft_win_win(t0,y0,win,numwin,rmfit);
...
for i=1:numwin
    ...
    disp(['var=' num2str(var) '; ratio variance/sum_P*df: ' num2str(var/sump)]);
end
