%% function [period,freq,power,camp] = fft_tukey_lin(t,y,tukw,rmfit)
%  Maarten Buijsman, USM, 2016-03-15
%  performs simple spectral analysis
%  input:  equidistant time vector t and data y
%          when tukw=1, a tukey window is applied over the full length of the data set
...
function [period,freq,power,camp] = fft_tukey_lin(t,y1,tukw,rmfit);
