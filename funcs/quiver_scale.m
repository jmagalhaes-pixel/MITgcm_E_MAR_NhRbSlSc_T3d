...
%QUIVER Quiver plot.
%   Modified by MCB, 150803, if S is 1 then autoscale, if S not equal 1
%   then scale by S
%
...
nin = nargin; %% count number of inputs
...
%% scale the length of the vectors MCB150803
if autoscale ~= 1 %MCB150803
    u = u*autoscale; v = v*autoscale; %MCB150803
elseif autoscale == 1, %% if 1 then executed, %MCB150803
%if autoscale, 
