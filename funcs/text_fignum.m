...
if strcmp(vertloc,'top')
    if strcmp(horloc,'left')
        handle = text(xlim(1)+offh,ylim(2)+offv,['\bf' str],'VerticalAlignment','top','HorizontalAlignment','Le','fontsize',fs);
    elseif strcmp(horloc,'right')
        handle = text(xlim(2)+offh,ylim(2)+offv,['\bf' str],'VerticalAlignment','top','HorizontalAlignment','Ri','fontsize',fs);
    end
elseif strcmp(vertloc,'bottom')
    if strcmp(horloc,'left')
        handle = text(xlim(1)+offh,ylim(1)+offv,['\bf' str],'VerticalAlignment','bottom','HorizontalAlignment','Le','fontsize',fs);
    elseif strcmp(horloc,'right')
        handle = text(xlim(2)+offh,ylim(1)+offv,['\bf' str],'VerticalAlignment','bottom','HorizontalAlignment','Ri','fontsize',fs);
    end
end
