C $Header: /u/gcmpack/MITgcm/pkg/generic_advdiff/gad_som_adv_r.F,v 1.5 2008/08/12 22:25:21 jmc Exp $
...
CEOP
      ...
      recip_dT = 0.
      IF ( deltaTloc.GT.0.d0 ) recip_dT = 1.0d0 / deltaTloc
