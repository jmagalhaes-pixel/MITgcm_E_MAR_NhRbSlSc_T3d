C $Header: /u/gcmpack/MITgcm/pkg/mdsio/mdsio_pass_wh_r4tors.F,v 1.1 2010/09/24 18:39:35 gforget Exp $
...
CBOP
C !ROUTINE: MDS_PASS_WH_R4toRS
C !INTERFACE:
      SUBROUTINE MDS_PASS_WH_R4toRS( buffer, arrFld, nNz, kLo, kSize,
...
C myThid  (integer):: my Thread Id number
      ...
      Real*8    arrFld(1:sNxWh,1:sNyWh,kSize,nSx,nSy)
      INTEGER kLo
      INTEGER biArg
      INTEGER bjArg
      LOGICAL copyTo
...
CEOP
     ...
     &   .AND. bjArg.GE.1 .AND. bjArg.LE.nSy ) THEN
        ...
        ENDIF
      ELSE
        STOP 'ABNORMAL END: MDS_PASS_WH_R4toRS invalid bi,bj Arg'
      ENDIF
