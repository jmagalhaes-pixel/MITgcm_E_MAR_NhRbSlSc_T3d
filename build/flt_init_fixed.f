C $Header: /u/gcmpack/MITgcm/pkg/flt/flt_init_fixed.F,v 1.3 2009/04/28 18:15:33 jmc Exp $
...
C Set domain dependent constants:
      ...
      DO bj=myByLo(myThid),myByHi(myThid)
       ...
       ENDDO
      ENDDO
      CALL GLOBAL_MAX_R8 (  xLo,  myThid  )
      CALL GLOBAL_MAX_R8 (  xHi,  myThid  )
      CALL GLOBAL_MAX_R8 (  yLo,  myThid  )
      CALL GLOBAL_MAX_R8 (  yHi,  myThid  )
