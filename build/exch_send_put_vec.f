...
C     myThid        :: my Thread Id. number
      INTEGER myd1
      Real*8  arrayE(myd1,nSx,nSy),  arrayW(myd1,nSx,nSy)
      Real*8 bufRecE(myd1,nSx,nSy), bufRecW(myd1,nSx,nSy)
      INTEGER myThid
CEOP
...
C     myThid        :: my Thread Id. number
      INTEGER myd1
      Real*8  arrayN(myd1,nSx,nSy),  arrayS(myd1,nSx,nSy)
      Real*8 bufRecN(myd1,nSx,nSy), bufRecS(myd1,nSx,nSy)
      INTEGER myThid
CEOP
