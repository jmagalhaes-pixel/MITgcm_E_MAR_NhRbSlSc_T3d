...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
      Real*8 Uinflow,rampTime2
      Real*8 omegaF,ftide,facdmp,dumvar
      Real*8 omgF(1:8),amplF(1:8),phsF(1:8)

c
c      Uinflow  = 0.06667
c      omegaF   = 1.4053D-4  !M2 tidal frequency in rad/s
...
C for smoother looking solutions.
      rampTime2 = 1.D4
      facdmp = 1.d0 - exp(-1.d0/rampTime2*futureTime)
