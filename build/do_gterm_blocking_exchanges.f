...
c     CALL EXCH_XYZ_RL (  Gu ,  myThid  )
c     CALL EXCH_XYZ_RL (  Gv ,  myThid  )
c     CALL EXCH_XYZ_RL (  Gt ,  myThid  )
c     CALL EXCH_XYZ_RL (  Gs ,  myThid  )
      CALL EXCH_UV_XYZ_RL(guNm1,gvNm1,.TRUE.,myThid)
c     CALL EXCH_XYZ_RL (  guNm1 ,  myThid  )
c     CALL EXCH_XYZ_RL (  gvNm1 ,  myThid  )
      CALL EXCH_XYZ_RL (  gtNm1 ,  myThid  )
      CALL EXCH_XYZ_RL (  gsNm1 ,  myThid  )
c     CALL EXCH_XYZ_RL (  uVel ,  myThid  )
c     CALL EXCH_XYZ_RL (  vVel ,  myThid  )
