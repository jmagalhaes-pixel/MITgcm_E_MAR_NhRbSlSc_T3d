C $Header: /u/gcmpack/MITgcm/pkg/obcs/orlanski_east.F,v 1.11 2010/03/16 00:21:26 jmc Exp $
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
C $Header: /u/gcmpack/MITgcm/pkg/obcs/OBCS.h,v 1.25 2010/11/11 09:42:54 mlosch Exp $
C $Name: checkpoint62o $
...
C     etc
     ...
     &  OBNhfac0,OBShfac0,OBEhfac0,OBWhfac0
      Real*8 OBNhfac0(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBShfac0(1-Olx:sNx+Olx,nSx,nSy)
      Real*8 OBEhfac0(1-Oly:sNy+Oly,nSx,nSy)
      Real*8 OBWhfac0(1-Oly:sNy+Oly,nSx,nSy)
      COMMON /OB_NLFS/
...
cc
     ...
     &      CMax, cVelTimeScale, CFix, useFixedCEast, useFixedCWest
      Real*8   CMax, cVelTimeScale, CFix
...
C     Storage arrays
     ...
     &      WS_STORE_3,WS_STORE_4
      ...
      Real*8 UE_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UE_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UE_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UE_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VE_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VE_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VE_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VE_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TE_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TE_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TE_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TE_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SE_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SE_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SE_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SE_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WE_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WE_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WE_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WE_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UW_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UW_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UW_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UW_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VW_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VW_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VW_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 VW_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TW_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TW_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TW_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 TW_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SW_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SW_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SW_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 SW_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WW_STORE_1(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WW_STORE_2(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WW_STORE_3(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 WW_STORE_4(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 UN_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 UN_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 UN_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 UN_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VN_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VN_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VN_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VN_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TN_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TN_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TN_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TN_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SN_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SN_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SN_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SN_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WN_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WN_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WN_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WN_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 US_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 US_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 US_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 US_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VS_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VS_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VS_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 VS_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TS_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TS_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TS_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 TS_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SS_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SS_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SS_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 SS_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WS_STORE_1(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WS_STORE_2(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WS_STORE_3(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 WS_STORE_4(1-OLx:sNx+OLx,Nr,nSx,nSy)
...
C     Phase speed arrays
     ...
     &      CVEL_US,CVEL_VS,CVEL_TS,CVEL_SS,CVEL_WS
      ...
      Real*8 CVEL_UE(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_VE(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_TE(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_SE(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_WE(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_UW(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_VW(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_TW(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_SW(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_WW(1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 CVEL_UN(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_VN(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_TN(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_SN(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_WN(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_US(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_VS(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_TS(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_SS(1-OLx:sNx+OLx,Nr,nSx,nSy)
      Real*8 CVEL_WS(1-OLx:sNx+OLx,Nr,nSx,nSy)
...
C     == Local variables ==
      INTEGER J, K, I_obc
      Real*8 CL, ab1, ab2, fracCVEL, f1, f2
